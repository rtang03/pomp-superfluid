...
import SlotsBitmapLibraryArtifact from "@superfluid-finance/ethereum-contracts/build/contracts/SlotsBitmapLibrary.json";
import SuperfluidFrameworkDeployerArtifact from "@superfluid-finance/ethereum-contracts/build/contracts/SuperfluidFrameworkDeployer.json";
import ERC1820Registry from "@superfluid-finance/ethereum-contracts/scripts/artifacts/ERC1820Registry.json";
...
export async function deployERC1820(provider: JsonRpcProvider) {
...
export const deployTestFramework: () => Promise<Contract> = async () => {
